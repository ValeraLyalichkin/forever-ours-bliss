  ...
  return (
    <section className="relative overflow-hidden min-h-screen bg-cream flex flex-col items-center justify-center px-6 pt-6 pb-8 sm:py-20">
      ...
      <div className="relative z-10 max-w-md w-full text-center mx-auto">
        ...
        <p className="font-script text-6xl sm:text-7xl md:text-8xl text-wine leading-[0.9]">
          и
        </p>
        <h1 className="font-script text-6xl sm:text-7xl md:text-8xl text-wine leading-[0.9]">
          Валерий
      ...
      <div className="relative z-10 mt-5 sm:mt-10 flex flex-col items-center gap-2">
        <div className="flex items-center gap-4">
          <span className="block w-16 h-px bg-wine/60" />
          <p className="font-num text-2xl md:text-3xl tracking-[0.2em] text-wine">
            15.08.26
          </p>
          <span className="block w-16 h-px bg-wine/60" />
        </div>
